...
public class Player2Punch : MonoBehaviour
{
    ...
    public static int increment, score2 ;
    ...
    void Start()
    {
        ...
        upSide = MovementPlayerTwo.upSide;
        downSide = MovementPlayerTwo.downSide;
        rightSide = MovementPlayerTwo.rightSide;
        leftSide = MovementPlayerTwo.leftSide;
    ...
    void punch()
    {
        ...
        if (Input.GetKey(KeyCode.Backspace) && upSide == true && rightSide == true)
        {
        ...
        else if (Input.GetKey(KeyCode.Backspace) && downSide == true && rightSide == true)
        {
        ...
        else if (Input.GetKey(KeyCode.Backspace) && upSide == true && leftSide == true)
        {
        ...
        else if (Input.GetKey(KeyCode.Backspace) && downSide == true && leftSide == true)
        {
